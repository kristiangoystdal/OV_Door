...
pyinstaller --clean --onefile --noupx --windowed --add-data="C:\Users\krisg\Documents\Git\OV_Door\Windows\installer\ov_logo.ico;." --icon="C:\Users\krisg\Documents\Git\OV_Door\Windows\ov_logo.ico" --name="installer_omega_verksted" installer.py
